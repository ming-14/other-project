TrID (C) 2003-26 By Marco Pontello

Info: http://mark0.net/soft-trid-e.html
E-Mail: marcopon@gmail.com

Required System: any platform with a modern version of Python 3
(tested on Python 3.6.9 and up, no other dependencies)

If the StringZilla library ("pip install stringzilla") is installed,
TrID run can run much faster (2x to 4x is typical)!
...
See here: https://mark0.net/soft-tridscan-e.html

Check the website for more info & changes log!
...
Or you can make a donation, see the Contacts Info on my home page.
